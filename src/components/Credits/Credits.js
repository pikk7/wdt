...
import {Link,Collapse,ListItemIcon,ListItemText,ListItem,List,ListSubheader} from "@material-ui/core";

const credits=[
  {name:"Pikk7",urls:[{name: "Instagram", URL: "https://www.instagram.hu/pikkhet"}, {
          name: "Facebook",
